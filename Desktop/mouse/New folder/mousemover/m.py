...
def main():
    print(
        "Starting mouse mover: hover every "
        f"{HOVER_INTERVAL_SECONDS}s, scroll every {SCROLL_INTERVAL_SECONDS}s. Ctrl+C to stop."
    )
    print("Failsafe also triggers by slamming the mouse to a corner.")
    ...
    try:
        ...
        print("Stopped by pyautogui failsafe (mouse moved to a corner).")
    finally:
        print("Exiting.")
